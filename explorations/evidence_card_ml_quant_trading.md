...
**可提取率**: 5.5/8 组件——部分提取——显著高于 NPGS（痕迹提取层级）。
...
**增量发现**：有学术论文的项目比纯代码项目多提供了显著的方法论可提取性。论文充当了"被动的方法论文档"——它不是为 AI 协作写的，但恰好提供了提取框架需要的设计意图和理论背景。
...
| 项目 | 方法论自觉 | 提取层级 |
|------|:--------:|------|
| 自有项目（ETF/M&A 等） | ★★★★★ | 完整/主要提取 |
| ml-quant-trading | ★★★ | 部分提取 |
| NPGS | ★ | 痕迹提取 |
