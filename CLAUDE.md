...
- 对照实验项目 D处于搁置状态（方法论资产冻结在协议文档中）
- 量化竞赛项目 C 为活跃项目（非闭合），提取时需注意状态差异
...
| ID | 状态 | 描述 |
|----|------|------|
| OPEN-1 | ✅已关闭 | 12个源项目全部提取完成（Phase 2）。量化竞赛项目 C按活跃边界案例处理，降低归纳权重 |
...
| 源项目 | 提取状态 | 对本项目的输入 |
|--------|---------|---------------|
| 量化策略项目 A | CLAUDE.md嵌入 | 18版本迭代模式、Bug教训清单、负迁移检验 |
| 并购重组案例 | Playbook v1.2 | 八阶段流水线、开卷/盲答对照、Phase 0 kill-test |
| 对照实验项目 D | 协议冻结 | 预登记实验设计、污染三层诊断、治理审计 |
| 方法论评估项目 B | 4轮bug-hunt | 14类目评分框架、对抗式阅读checklist |
...
| 量化竞赛项目 C | 活跃（非闭合） | Walk-Forward验证、形态匹配复用 |
